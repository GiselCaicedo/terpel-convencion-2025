    ...
    <div className="relative w-full overflow-hidden" style={{ minHeight: '400px' }}>
      ...
      <div className="absolute top-0 left-0 w-full md:w-1/2 lg:w-2/5 h-full flex flex-col justify-center px-4 sm:px-6 md:px-8 py-8 z-10">
        ...
        <button
          ...
          className="group relative px-4 py-2 md:px-6 md:py-3 text-white border-2 border-white rounded-full hover:bg-white transition-all duration-300 flex items-center justify-center overflow-hidden w-40"
        >
